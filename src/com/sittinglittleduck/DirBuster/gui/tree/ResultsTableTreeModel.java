        ...
        implements TreeTableModel
{
    ...
    {
        /*
         * I bit dirty this part TODO: see if there is a better way
         */
        super(null);
        super.root = rootNode;
        ...
        for(int a = 0; a < items.size(); a++)
        {
            ...
            if(node == null)
            {
                ...
                if(a == items.size() - 1)
                {
                    ...
                    fireTreeNodesInserted(rootTemp, getPathToRoot(rootTemp), new int[]
                            {
                                rootTemp.getChildren().length - 1
                            }, rootTemp.getChildren());
             ...
             */ else
            {
                if(!rootTemp.isResultSet() && a == (items.size() - 1))
                {
                    rootTemp.setResult(result);
                    /*
                    ...
                    this.fireTreeNodesChanged(rootTemp, getPathToRoot(rootTemp), new int[]
                            {
                                rootTemp.getChildren().length - 1
                            }, rootTemp.getChildren());
                    return;
