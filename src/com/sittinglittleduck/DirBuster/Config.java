...
public class Config
{
     ...
     * Multi threaded all the work generation, so multiple dir and file exts are scaned at the same time
     * Restuctured multiple parts of the code
     * Proxy settings are now persitent
     * The ability to change the look and feel has now been added
     * Added Jbrofuzz dir list
     * Removed the two large dirlists
     * 
     * 
     * 0.12
